...
from ppdiffusers.transformers import TrOCRProcessor, VisionEncoderDecoderModel
...
def main():
    ...
    model_path = f"outputs2/{args.exp_name}/latest"
    ...
    image_paths = [
        "dataset/UniMER/raw/UniMER-Test/spe",
        "dataset/UniMER/raw/UniMER-Test/cpe",
        "dataset/UniMER/raw/UniMER-Test/sce",
        "dataset/UniMER/raw/UniMER-Test/hwe",
    ]
    math_files = [
        "dataset/UniMER/raw/UniMER-Test/spe.txt",
        "dataset/UniMER/raw/UniMER-Test/cpe.txt",
        "dataset/UniMER/raw/UniMER-Test/sce.txt",
        "dataset/UniMER/raw/UniMER-Test/hwe.txt",
    ]
